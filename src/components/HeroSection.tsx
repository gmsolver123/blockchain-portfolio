          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
                ...
                a Senior Blockchain Engineer with expertise in smart contract development, Web3 integration, 
                and full-stack dApp engineering. Let's build something extraordinary together.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="btn-cyber group flex items-center whitespace-nowrap"
              >
              ...
              <button 
                ...
                className="btn-ghost group flex items-center whitespace-nowrap"
              >
